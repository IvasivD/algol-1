...
type
  ...
  public
    ...
    function DisplayOriginDateTag: string;
...
function TImageMetaData.DisplayOriginDateTag: string;
var
  I: integer;
begin
  try
    Result := '';
    for I:= 0 to High(TagsArray) do
      if (TagsArray[I].Id = TagID_OriginalDate) and (string(TagsArray[I].Value) <> '') then
        Result:= string(TagsArray[I].Value);
  except
  end;
end;
