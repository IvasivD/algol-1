...
begin
  ...
  begin
    ...
    CityQry := UnitIBQuery.CreateDataSet( DBParam.PathDB, DBParam.UID, DBParam.Password, nil, FMainSql );
  end
  else
...
function TFrameSearchCity.IsEnabled:Boolean;
begin
  result := self.EdSearchCity.Enabled ;
end;
