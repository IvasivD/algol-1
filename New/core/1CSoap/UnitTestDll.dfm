object Form1: TForm1
  ...
  object Button9: TButton
    ...
    Width = 136
    Height = 25
    Caption = 'Synhronize Bank Account'
    TabOrder = 10
  ...
  object Button17: TButton
    ...
    Width = 249
    Height = 25
    Caption = 'Update Clients to 1C by IDENT Code and Name'
    TabOrder = 17
  ...
  object ADOConnection1: TADOConnection
    ConnectionString = 
      ...
      's="DSN=MySqlSource;SERVER=localhost;UID=root;PWD=root;DATABASE=t' +
      'est;PORT=3306"'
    LoginPrompt = False
    Provider = 'MSDASQL.1'
    Left = 216
  ...
  object ADOConnection: TADOConnection
    Connected = True
    ConnectionString = 
      'password=masterkeyProvider=MSDASQL.1;Password=masterkey;Persist ' +
      'Security Info=True;User ID=SYSDBA;Extended Properties="Driver=Fi' +
      'rebird/InterBase(r) driver;Dbname=alfa:D:\Tourmn\nettour\_TOURIB' +
      '_TEST.GDB;"'
    LoginPrompt = False
    Left = 295
    Top = 140
